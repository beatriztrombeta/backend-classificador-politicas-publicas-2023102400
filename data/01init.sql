...
CREATE TABLE IF NOT EXISTS DISCIPLINA (
  ...
  NOME_DISCIPLINA_NORMALIZADO VARCHAR NOT NULL,

  CONSTRAINT FK_DISCIPLINA_CURSO FOREIGN KEY (ID_CURSO) REFERENCES CURSO (ID_CURSO)
);

CREATE INDEX IDX_DISCIPLINA_NOME_NORMALIZADO
  ON DISCIPLINA (NOME_DISCIPLINA_NORMALIZADO);

CREATE INDEX IDX_DISCIPLINA_CURSO_NOME_NORMALIZADO
  ON DISCIPLINA (ID_CURSO, NOME_DISCIPLINA_NORMALIZADO);
