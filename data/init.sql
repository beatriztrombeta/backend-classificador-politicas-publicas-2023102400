...
CREATE TABLE USUARIO_PROREI (
  ID_USUARIO INTEGER,
  ID_PROREITORIA INTEGER,
  PRIMARY KEY (ID_USUARIO, ID_PROREITORIA),
  FOREIGN KEY (ID_USUARIO) REFERENCES USUARIO (ID_USUARIO),
  FOREIGN KEY (ID_PROREITORIA) REFERENCES TIPO_PROREITORIA (ID_TIPO_PROREITORIA)
);
